package info.pppc.base.tutorial.emulator;
...
import info.pppc.base.tutorial.rmi.RmiProxy;
...
import info.pppc.basex.plugin.transceiver.MxIPEmulatorTransceiver;

/**
 * Demonstrates the emulator plug-in with 4 devices. See the package
 * description and the scenario file for more details. 
 * 
...
public class EmulatorMain {
	...
	public static void main(String[] args) {
		...
		m.addPlugin(new MxIPEmulatorTransceiver("info/pppc/base/tutorial/emulator/scenario.txt"));
		m.addPlugin(new ProactiveDiscovery());
		m.addPlugin(new RmiSemantic());
		m.addPlugin(new ObjectSerializer());
		// you can uncomment the multi-hop routing plugin to connect all devices
		m.addPlugin(new ProactiveRouting(true));
